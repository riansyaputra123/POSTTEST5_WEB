...
<body>
    ...
    <table>
        <tr>
        <th colspan="6" style="background-color: #293462 ;">Popular Now </th>
        </tr>
        ...
        <?php $i++; endforeach;?>
        <tr>
        <th colspan="6" style="background-color: #293462 ;">Cancel view playlist? <a  class="daftar" href="admin.php" style="text-decoration:none">Back</a></th>
        </tr>
    </table>
